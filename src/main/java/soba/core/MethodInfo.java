...
public class MethodInfo {
    ...
    /**
     * @return true if the method may be overridden by a subclass. In other words,
     *         the method is a non-final, non-private instance method.
     */
    ...
    /**
     * @return the return value type. The method may return a generic type name such
     *         as "T".
     */
    ...
    public int getReceiverObjectParamIndex() {
        assert !isStatic();
        return 0; // "this" is always the first argument even if a method is invoked for an
                  // inner/anonymous class.
    }

    /**
     * This method translates "N-th" parameter to an index value for the local
     * variable table. This method is required because a double-word (long, double)
     * variable occupies two words in a local variable table.
     * 
     * @param paramIndex specifies the position of a parameter. E.g. 0, 1, 2, ...
     *                   indicate the first, the second, the third, ... parameters.
     ...
     * 
     * @return a position of the parameter corresponding to an index value for the
    ...
    /**
     * @param localVarialbleIndex specifies an index value for the local variable
     *                            table.
     * @return true if a local variable specified by the index value is a parameter
     *         of this method.
     */
     ...
     * @return a type name for the parameter. A class name is fully qualified. The
     *         name may be a generic type parameter such as "T". An inner class name
     *         is concatinated by ".". For example, "A.B" is returned for a type
     *         "A<T>.B".
     */
    ...
    /**
     * @return the maximum line including an instruction of the method. 0 indicates
     *         the method has no line number information.
     */
    ...
    /**
     * @return the minimum line including an instruction of the method. 0 indicates
     *         the method has no line number information.
     */
    ...
    /**
     * @return an array which is filled with the numbers from minimum line to
     *         maximum line.
     */
    ...
    /**
     * @param line
     * @return an array of instruction index values that consist of a specified
     *         line.
     */
    ...
    /**
     * Returns an invocation in a method call instruction. If the instruction is not
     * a method call, this method returns null.
     * 
     * @param instructionIndex
    ...
    private CallSite.Kind getInvokeType(MethodInsnNode m) {
        ...
        else if (m.getOpcode() == Opcodes.INVOKESPECIAL)
    ...
    /**
     * Returns a field access in an instruction. If the instruction is not a field
    ...
    /**
     * @return a <code>DataDependence</code> object. The object has information
    ...
    /**
     * @return a conservative control-flow graph. The graph assumes that every
     *         instruction in a try block may throw an exception.
     */
