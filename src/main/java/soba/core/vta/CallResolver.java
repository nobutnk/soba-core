...
/**
 * This class wraps VTA resolver and CHA resolver. While VTAResolver resolves
 * only INVOKEVIRTUAL and INVOKEINTERFACE, this wrapper object can easily
 * resolve all invocations using both algorithms.
 */
public abstract class CallResolver implements IDynamicBindingResolver {
    ...
    /**
     * @param c specifies a call site. This instance must be extracted from
     *          MethodBody object.
     * @return
     */
