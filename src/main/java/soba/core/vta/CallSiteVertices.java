...
/**
 * An instance of MethodParameters represents a set of formal parameters of a
 * method or a set of actual parameters of a method call.
 */
class CallSiteVertices {

    /**
     * The number of formal parameters of the method. This includes "this", excludes
     * a return value.
     */
    private int paramCount;

    /**
     * paramIndex[vertexIndex] specifies the position of a method argument
     * corresponding to the vertex. If paramIndex[vertexIndex] == paramCount, the
     * vertex represents a return value.
     */
    ...
    /**
     * vertexTypes[vertexIndex] indicates a type name corresponding to the vertex.
     */
    ...
    /**
     * @return a call site information. This method returns non-null for objects
    ...
    /**
     * @param param specifies the position of a method parameter in the parameter
     *              list.
     * @return
     */
