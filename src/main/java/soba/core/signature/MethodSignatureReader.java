...
/**
 * This class translates a method signature to a list of parameters, a return
 * type, and a list of exception types. TODO The current implementation ignores
 * type arguments for generic class.
 */
public class MethodSignatureReader {
    ...
    public MethodSignatureReader(String signature) {
        ...
        sigReader.accept(new SignatureVisitor(Opcodes.ASM5) {
            ...
            /*
             * SignatureVisitor for a method signature receives a following method call
             * sequence. ( visitFormalTypeParameter visitClassBound? visitInterfaceBound* )*
        ...
        assert paramTypeVisitors.size() == paramCount : "Failed to read a method signature: paramTypes="
                + Integer.toString(paramTypeVisitors.size()) + ", paramCount=" + Integer.toString(paramCount);
    }
