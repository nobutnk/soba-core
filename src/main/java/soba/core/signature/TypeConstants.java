...
public class TypeConstants {
     ...
     * @return true if a given name is a primitive types (excluding "void").
     */
    ...
    /**
     * return name == primitive || name == void NOTE: name is normal type name. (NOT
     * bytecode descriptor, such as I or Z)
     * 
     * @param name
     * @return
     */
     ...
     * @return the number of words to store the type. 2 is returned for double and
     *         long.
     */
