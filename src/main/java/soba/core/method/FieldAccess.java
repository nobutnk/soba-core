...
public class FieldAccess {
    ...
    /**
     * Creates a new <code>FieldAccess</code> instance representing a load
     * instruction of a field.
     * 
    ...
    /**
     * Creates a new <code>FieldAccess</code> instance representing a store
     * instruction of a field.
     * 
     * @param className is a class name of the accessed field.
     * @param fieldName is a field name.
    ...
    public int hashCode() {
        ...
        result = prime * result + ((fieldDesc == null) ? 0 : fieldDesc.hashCode());
