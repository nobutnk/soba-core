...
public class DataFlowEdge {
     ...
     * @param variableIndex is a index value of a local variable table or operand
     *                      stack.
    ...
    /**
     * @return the index value of an instruction which produces data. This method
     *         returns -1 if the definition instruction cannot be resolved. For
     *         example, a catch clause starts with ASTORE instruction whose data
     *         source cannot be resolved. If isParameter() is true, it is a
     *         parameter from outside of the method.
     */
    ...
    /**
     * @return a variable index pointing to an entry in a local variable table or a
     *         operand stack.
     */
    ...
    /**
     * @return true if the edge represents a data-flow through a local variable. The
     *         method returns false for a data-flow edge for an operand stack.
     */
