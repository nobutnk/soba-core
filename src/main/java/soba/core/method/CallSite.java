...
public class CallSite {
    ...
    /**
     * @return true if the method is NOT a virtual method call. In other words, the
     *         method to be invoked is declared as static or a certain
     *         implementation is specified by the invocation, e.g. "super.m()".
     */
