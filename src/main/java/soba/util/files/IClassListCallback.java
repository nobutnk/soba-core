...
public interface IClassListCallback {
     ...
     * @return The implementation returns true if the implementation want to process
     *         the data. The implementation may return false to skip the data.
     */
     ...
     * @return The implementation returns true if the implementation want to stop
