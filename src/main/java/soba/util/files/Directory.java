...
public class Directory implements IClassList {
     ...
     * 
     * @param topDir specifies a directory including sub-directories to be
     *               enumerated.
     * @param depth  specifies the maximum number of recursive search. "0" returns
     *               the top directory itself. "1" returns a list of directories in
     *               the top directory.
     * @return
     */
    ...
    private class FileFilterCallback implements FileFilter {
        ...
        public boolean accept(File f) {
            return f.isDirectory() || (searchZip && ZipFile.isZipFile(f))
