...
public class IntPairList {
    ...
    /**
     * @param capacity specifies the list size. Creates a new
     *                 <code>IntPairList</code> instance with the specified size.
     */
    ...
    /**
     * This method freezes the list and releases unnecessary memory buffer for
     * additional elements. If you add a new pair of integers, this list throws an
     * exception.
     */
    public void freeze() {
        frozen = true;
