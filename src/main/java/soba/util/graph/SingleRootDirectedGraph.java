...
public class SingleRootDirectedGraph implements IDirectedGraph {
    ...
    /**
     * Creates a new <code>SingleRootDirectedGraph</code> instance from a base
     * graph. The instance is a directed graph with a single root. The root is
     * connected to vertices which have no incoming edges in the original graph.
     * 
    ...
    public SingleRootDirectedGraph(IDirectedGraph base) {
        ...
        // To find vertices without incoming edges, first cycles must be removed from
        // the graph.
