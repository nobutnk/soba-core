...
/**
 * <code>IntSetStack</code> is a stack in which int values can be stored. The
 * stack cannot contain two instances of the same value; for example,
 * "aIntSetStack.push(0); aIntSetStack.push(0);" causes a
 * DuplicatedValueException. Instead of the set constraint, this stack provides
 * O(1) implementation of contains(int).
 */
public class IntSetStack extends IntStack {
    ...
    public void push(int value) {
        if (max < value)
            throw new InvalidElementException(max, value);
    ...
    public class InvalidElementException extends RuntimeException {
        ...
        public String getMessage() {
            return "The given value cannot be stored into the stack. MAX=" + Integer.toString(max) + ", VALUE="
