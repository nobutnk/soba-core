...
public class MethodInfoTest implements ExampleProgram {
    ...
    public void testMethodInfo01() {
        ...
        assertThat(m.toLongString(),
                is(CLASS_D + ".example(" + CLASS_D + ":this, int:i, long:l, double:d, java/lang/String:s): int"));
    ...
    public void testMethodInfo02() {
        ...
        assertThat(UtilForAssertThat.asIntegerArray(m.getInstructions(11)),
                is(arrayContainingInAnyOrder(6, 7, 8, 9, 10, 11)));
