...
public class FastSourceValueTest {
    ...
    public void testMerge() {
        ...
        Integer[] instructions123456another = UtilForAssertThat
                .asIntegerArray(value123456anotherConcat.getInstructions());
        ...
        Integer[] instructions123456anotherMix = UtilForAssertThat
                .asIntegerArray(value123456anotherMix.getInstructions());
        ...
        Integer[] instructions123differentAnother = UtilForAssertThat
                .asIntegerArray(value123differentSizeAnother.getInstructions());
